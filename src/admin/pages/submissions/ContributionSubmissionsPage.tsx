 ...
 * "Create Innovation Record from This Submission" CTA revealed ONLY when disposition === 'ACCEPTED_FOR_CURATION'.
 * CTA calls POST /api/v1/admin/contribution-submissions/:id/create-record, then navigates to /admin/records/:id/edit
 *
 * API:
 ...
 *   POST  /api/v1/admin/contribution-submissions/:id/create-record — create record from submission
 *
...
const SubmissionDetail: React.FC<{
  ...
  // Track whether current saved disposition is ACCEPTED_FOR_CURATION
    ...
    >
      ...
      >
        ...
        <div style={{ borderTop: '1px solid #E5E7EB', marginTop: '24px', paddingTop: '24px' }}>
          ...
          {/* Create Record CTA — visible ONLY when disposition === ACCEPTED_FOR_CURATION */}
          {showCreateRecordCTA && (
            <div
              style={{
