 ...
 *
 * Note: Canonical implementation lives at src/admin/pages/submissions/OpportunitySubmissionsPage.tsx.
    ...
    >
      ...
      >
        ...
        <div style={{ borderTop: '1px solid #E5E7EB', marginTop: '24px', paddingTop: '24px' }}>
          ...
          {/* Conditional linked record ID input — shown only when LINKED_TO_RECORD selected */}
        ...
        {/* Disposition history — displayed when reviewed_at is present */}
...
export const OpportunitySubmissionsPage: React.FC = () => {
  ...
  return (
    <div style={{ padding: '0' }}>
      ...
      {/* Submissions table — reverse-chronological (submitted_at DESC from API) */}
      {!loading && !error && submissions.length > 0 && (
        <>
